    ...
    return (
        <>
            ...
            <div className="flex gap-5 justify-center mb-10 font-poppins">
                <button className="bg-amber-500 w-[10rem] py-3 rounded" onClick={() => handlePagination('prev')}>Previous</button>
                <button className="bg-amber-500 w-[10rem] py-3 rounded" onClick={() => handlePagination('next')}>Next</button>
            </div>
        </>
    )
}