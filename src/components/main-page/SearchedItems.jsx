...
export default function SearchedItems({ val, setSearchItem }) {
    ...
    return (
        <>
            ...
            {filteredCoins.map((a, i) =>
                <Link onClick={() => setSearchItem(a.name)} to={'/market/' + a.name} key={i} className="border-b mx-3 border-zinc-700 py-4 flex justify-between">
